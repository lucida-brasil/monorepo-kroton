...
import BannersComponent from './direflow-components/banners-component';

BannersComponent.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('banners-component is mounted on the DOM', element);
});
